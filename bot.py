...
def generate_text(user_id, mode):
    ...
    if mode == "post":
        ...
        full_prompt = (
            ...
            "Контекст из книг: '{context}'. "
            "Пиши исключительно на русском языке, категорически запрещено использовать любые иностранные слова (английские, испанские, немецкие и т.д.) — заменяй их русскими эквивалентами (например, 'aged' — 'в возрасте', 'thoughts' — 'мысли', 'confidence' — 'уверенность', 'find' — 'найти'). "
        ...
        full_prompt = (
            ...
            "Контекст из книг: '{context}'. "
            "Пиши исключительно на русском языке, категорически запрещено использовать любые иностранные слова — заменяй их русскими эквивалентами (например, 'post' — 'пост', 'reels' — 'короткие видео', 'confidence' — 'уверенность'). "
            ...
            if response.status_code == 200:
                ...
                if re.search(r'[^\u0400-\u04FF\s\d.,!?():;-]', corrected_text):  # Проверка на не-русские символы
                    ...
                    replacements = {
                        ...
                        'regular': 'регулярный', 'grooming': 'уход', 'tips': 'советы', 'satisfied': 'довольные',
                        'clients': 'клиенты', 'about': 'о', 'our': 'наших', 'services': 'услугах', 'how': 'как',
                        'to': '', 'keep': 'сохранить', 'your': 'ваши', 'hair': 'волосы', 'healthy': 'здоровыми',
                        'and': 'и', 'strong': 'сильными', 'care': 'ухаживать', 'for': 'за', 'at': 'дома',
                        'home': 'дома', 'verbessern': 'улучшить'
                    }

...
def generate_ideas(topic, style="саркастичный"):
    prompt = (
        ...
        f"Примеры для темы 'верность' в стиле 'формальный': "
        f"Организуйте встречу с близкими и обсудите с подписчиками значение верности в жизни "
        f"Подготовьте рассказ о преданности и поделитесь выводами с аудиторией для обсуждения "
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if len(filtered_ideas) < 3 or not all(topic in idea.lower() for idea in filtered_ideas):
                fallback_ideas = {
                    "саркастичный": {
                        "поездка": [
                        ...
                        "верность": [
                            ...
                            f"Запусти челлендж на преданность и докажи, что никто не выдержит дольше тебя"
                        ],
                        "сторис": [
                    ...
                    "дружелюбный": {
                        ...
                        "верность": [
                            ...
                            f"Запиши историю о дружбе и поделись с подписчиками своими уроками преданности",
                        ...
                        "сторис": [
                            ...
                            f"Поделись моментом дня и предложи друзьям показать свои истории"
                        ]
                    },
                    "формальный": {
                        "поездка": [
                        ...
                        "сторис": [
                            ...
                            f"Подготовьте короткий отчёт и предложите подписчикам оценить вашу историю"
                        ]
                    }
                }

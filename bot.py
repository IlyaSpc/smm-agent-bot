...
def generate_ideas(topic, style="саркастичный"):
    prompt = (
        ...
        f"Примеры для темы 'музыка' в стиле 'дружелюбный': "
        f"Собери плейлист из хитов и поделись с друзьями для весёлого вечера "
        f"Запиши свою мелодию и спроси подписчиков, что бы они добавили "
        f"Создай музыкальный челлендж и пригласи друзей присоединиться к нему "
            ...
            if len(filtered_ideas) < 3:
                ...
                fallback_ideas = {
                    "саркастичный": {
                        ...
                        "музыка": [
                            "Сними свой плейлист и спроси подписчиков, кто перепоёт твои треки",
                            "Покажи гитару и убеди друзей, что ты рок-звезда в душе",
                            "Запусти челлендж на музыку и докажи, что твой вкус всех затмит"
                        ],
                        "пробежка": [
                            "Сними кроссовки и спроси подписчиков, кто пробежит дальше тебя",
                            "Покажи свой маршрут и убеди друзей, что ты король пробежек",
                            "Запусти челлендж на бег и докажи, что никто не быстрее тебя"
                        ]
                    },
                    "дружелюбный": {
                        "поездка": [
                        ...
                        "музыка": [
                            "Собери плейлист из хитов и поделись с друзьями для весёлого вечера",
                            "Запиши свою мелодию и спроси подписчиков, что бы они добавили",
                            "Создай музыкальный челлендж и пригласи друзей присоединиться к нему"
                        ],
                        "пробежка": [
                            "Сделай фото трассы и расскажи друзьям, как пробежка бодрит тебя",
                            "Запиши свой бег и поделись с подписчиками радостью движения",
                            "Создай маршрут пробежки и пригласи друзей пробежать его вместе"
                        ]
                    },
                    "формальный": {
                        "поездка": [
                        ...
                        "музыка": [
                            "Организуйте прослушивание музыки и обсудите с подписчиками её влияние",
                            "Подготовьте обзор жанров и поделитесь выводами с аудиторией",
                            "Проведите опрос о музыке и опубликуйте результаты для участников"
                        ],
                        "пробежка": [
                            "Организуйте пробежку и обсудите с подписчиками её преимущества",
                            "Подготовьте отчёт о беге и поделитесь выводами с аудиторией",
                            "Проведите опрос о пробежках и опубликуйте результаты для участников"
                        ]
                    }
                }
...
def generate_hashtags(topic):
    ...
    thematic_hashtags = {
        ...
        "музыка": ["#музыка", "#песни", "#мелодия", "#ритм", "#вдохновение", "#творчество", "#энергия", "#эмоции", "#друзья", "#радость"],
        "пробежка": ["#пробежка", "#бег", "#спорт", "#утро", "#здоровье", "#энергия", "#мотивация", "#движение", "#сила", "#свобода"],
        "боулинг": ["#боулинг", "#игра", "#друзья", "#веселье", "#страйк", "#спорт", "#отдых", "#команда", "#развлечения", "#успех"]
    }
    relevant_tags = []

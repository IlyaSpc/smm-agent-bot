        ...
        if response.status_code == 200:
            ...
            if len(filtered_ideas) < 3:
                ...
                fallback_ideas = {
                    "саркастичный": {
                        "поездка": [
                            f"Сфотографируй свой чемодан и спроси подписчиков, сколько барахла они берут в поездку",
                            f"Сними видео с пробками и убеди друзей, что ты чемпион по выживанию в дороге",
                            f"Запусти опрос про худшую поездку и посмотри, чья история всех переплюнет"
                        ],
                        "верность": [
                            f"Сними клятву верности и спроси подписчиков, сколько раз они её нарушали",
                            f"Похвастайся своим терпением и убеди друзей, что ты святой по жизни",
                            f"Запусти челлендж на верность и докажи, что никто не выдержит дольше тебя"
                        ],
                        "сторис": [
                            f"Сними свою неудачу и спроси подписчиков, как бы они это исправили",
                            f"Покажи свой день в сторис и убеди друзей, что ты живёшь интереснее",
                            f"Запусти опрос про сторис и докажи, что твои идеи всех затмевают"
                        ],
                        "свет": [
                            f"Сними выключатель и спроси подписчиков, кто выживет без света дольше",
                            f"Покажи свою лампу и убеди друзей, что она ярче их жизни",
                            f"Запусти челлендж на свет и докажи, что ты мастер освещения"
                        ],
                        "футбол": [
                            f"Сними свой промах и спроси подписчиков, кто забьёт хуже тебя",
                            f"Покажи фанатский шарф и убеди друзей, что ты самый преданный болельщик",
                            f"Запусти челлендж на футбол и докажи, что твоя команда всех порвёт"
                        ],
                        "религия": [
                            f"Сними молитву и спроси подписчиков, кто продержится дольше на коленях",
                            f"Покажи свой храм и убеди друзей, что ты ближе к небесам",
                            f"Запусти челлендж на веру и докажи, что твоя религия всех переживёт"
                        ]
                    },
                    "дружелюбный": {
                        "поездка": [
                            f"Сделай фото в дороге и расскажи друзьям, что вдохновляет тебя в пути",
                            f"Запиши видео своих сборов и поделись советами с подписчиками для идеальной поездки",
                            f"Создай список любимых мест и предложи друзьям отправиться туда вместе"
                        ],
                        "верность": [
                            f"Сделай фото с близкими и расскажи друзьям, почему ты ценишь верность",
                            f"Запиши историю о дружбе и поделись с подписчиками своими уроками верности",
                            f"Создай список верных людей и предложи друзьям добавить своих героев"
                        ],
                        "сторис": [
                            f"Сделай короткое видео и расскажи друзьям, что вдохновило тебя сегодня",
                            f"Запиши свою идею и спроси подписчиков, как бы они её продолжили",
                            f"Поделись моментом дня и предложи друзьям показать свои сторис"
                        ],
                        "свет": [
                            f"Сделай фото лампы и расскажи друзьям, как свет создаёт уют дома",
                            f"Запиши видео заката и поделись с подписчиками своим любимым светом",
                            f"Создай список идей освещения и предложи друзьям попробовать их дома"
                        ],
                        "футбол": [
                            f"Сделай фото с мячом и расскажи друзьям, почему любишь футбол",
                            f"Запиши свой гол и поделись с подписчиками радостью от игры",
                            f"Создай список матчей и предложи друзьям посмотреть их вместе"
                        ],
                        "религия": [
                            f"Сделай фото храма и расскажи друзьям, что значит религия для тебя",
                            f"Запиши мысли о вере и поделись с подписчиками своими размышлениями",
                            f"Создай список традиций и предложи друзьям рассказать о своих обычаях"
                        ]
                    },
                    "формальный": {
                        "поездка": [
                            f"Организуйте фотосессию в поездке и зафиксируйте впечатления для коллег",
                            f"Проведите обзор маршрута и опубликуйте рекомендации для аудитории",
                            f"Подготовьте план путешествия и поделитесь выводами с подписчиками"
                        ],
                        "верность": [
                            f"Организуйте встречу с близкими и обсудите с подписчиками значение верности в жизни",
                            f"Подготовьте рассказ о верности и поделитесь выводами с аудиторией для обсуждения",
                            f"Проведите опрос о верности и опубликуйте результаты для всех участников"
                        ],
                        "сторис": [
                            f"Организуйте запись рассказа и поделитесь опытом с аудиторией для анализа",
                            f"Проведите обзор сторис и опубликуйте рекомендации для подписчиков",
                            f"Подготовьте короткий отчёт и предложите подписчикам оценить вашу сторис"
                        ],
                        "свет": [
                            f"Организуйте фотосессию света и поделитесь выводами с аудиторией для обсуждения",
                            f"Проведите обзор освещения и опубликуйте рекомендации для подписчиков",
                            f"Подготовьте анализ света и предложите аудитории оценить его влияние"
                        ],
                        "футбол": [
                            f"Организуйте просмотр матча и обсудите с подписчиками тактику игры",
                            f"Проведите обзор футболистов и опубликуйте рекомендации для аудитории",
                            f"Подготовьте отчёт о матче и предложите подписчикам поделиться впечатлениями"
                        ],
                        "религия": [
                            f"Организуйте встречу с верующими и обсудите с подписчиками значение религии",
                            f"Подготовьте рассказ о духовности и поделитесь выводами с аудиторией",
                            f"Проведите опрос о религии и опубликуйте результаты для всех участников"
                        ]
                    }
                }

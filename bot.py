...
def generate_text(user_id: int, mode: str):
    ...
    if mode == "post":
        full_prompt = (
            ...
            "Структура: начни с цепляющего вопроса или факта (AIDA), раскрой проблему аудитории, предложи решение, закрой возражения (например, 'а если нет времени?' или 'а вдруг дорого?'), покажи выгоду через пример, заверши призывом к действию. Пиши только текст поста."
...
def generate_hashtags(topic):
    ...
    thematic_hashtags = {
        ...
        "автомобилестроение": ["#авто", "#машины", "#технологии", "#автолюбители", "#движение", "#скорость", "#инновации", "#автомобиль"],
    }
    relevant_tags = []

...
def generate_text(user_id: int, mode: str):
    ...
    if mode == "post":
        full_prompt = (
            ...
            "Пиши ТОЛЬКО на русском языке, любые иностранные слова запрещены — используй русские эквиваленты (например, 'like' — 'например', 'correct' — 'правильный', 'existing relationships' — 'существующие связи'). "
        ...
        full_prompt = (
            ...
            "Цель текста: {goal}. Главная мысль: {main_idea}. Факты: {facts}. Боли и потребности аудитории: {pains}. "
            "Контекст из книг: '{context}'. "
            "Пиши ТОЛЬКО на русском языке, любые иностранные слова запрещены — используй русские эквиваленты. "

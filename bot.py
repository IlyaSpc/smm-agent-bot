...
def generate_ideas(topic, style="саркастичный"):
    prompt = (
        ...
        f"Каждая идея — одно полное предложение с призывом к действию и глаголом, минимум 5 слов, без странных или неуместных глаголов вроде 'смейся'. "
        f"Примеры для темы 'поездка' в стиле 'дружелюбный': "
        ...
        f"Создай список любимых мест и предложи всем отправиться туда вместе "
            ...
            if len(filtered_ideas) < 3:
                fallback_ideas = {
                    "саркастичный": [
                        ...
                        f"Сними видео с пробками и убеди всех, что ты чемпион по выживанию в дороге",

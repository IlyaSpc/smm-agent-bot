        ...
        if mode in ["post", "story"]:
            ...
            if mode == "post":
                full_prompt = (
                    ...
                    f"Обязательно используй идею: '{idea}' — текст должен строго следовать этой идее и развивать её без отклонений. "
            ...
            duration_weeks = 3 if "3 раза в неделю" in frequency else 2  # По умолчанию 3 недели, если указано "3 раза"
            full_prompt = (

...
def generate_ideas(topic, style="саркастичный"):
    prompt = (
        ...
        f"Примеры для темы 'футбол' в стиле 'дружелюбный': "
        f"Собери друзей на матч и поделись с подписчиками своими впечатлениями от игры "
        f"Запиши видео своего гола и спроси у друзей, кто забьёт лучше тебя "
        f"Создай список любимых игроков и предложи подписчикам дополнить его своими звёздами "
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if len(filtered_ideas) < 3:
                ...
                filtered_ideas.extend(fallback_ideas[style][:3 - len(filtered_ideas)])
